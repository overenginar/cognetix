...
def main(args):
    ...
    applog.logger.info(f'maxDepth: {rf_model._java_obj.getMaxDepth()}')
    applog.logger.info(f'numTrees: {rf_model._java_obj.getNumTrees()}')

    model.bestModel.write().overwrite().save(args.output_path)
